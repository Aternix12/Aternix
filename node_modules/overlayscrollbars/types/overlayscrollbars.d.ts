...
declare type EventListener$1<EventMap extends Record<string, any[]>, N extends keyof EventMap> = (...args: EventMap[N]) => void;
declare type InitialEventListeners$1<EventMap extends Record<string, any[]>> = {
    [K in keyof EventMap]?: EventListener$1<EventMap, K> | EventListener$1<EventMap, K>[];
};
...
export { ClickScrollPlugin, DynamicInitializationElement, EventListener, EventListenerMap, InitialEventListeners, Initialization, InitializationTarget, InitializationTargetElement, InitializationTargetObject, OnUpdatedEventListenerArgs, Options, OverflowBehavior, OverlayScrollbars, Plugin, PluginInstance, ScrollbarsAutoHideBehavior as ScrollbarAutoHideBehavior, ScrollbarsVisibilityBehavior as ScrollbarVisibilityBehavior, ScrollbarsHidingPlugin, SizeObserverPlugin, StaticInitializationElement };
