...
const createStructureSetupElements = t => {
  ...
  const k = {
    ...
    it: d,
    ut: A,
    dt: (t, n) => A ? hasAttrClass(z, O, n) : hasClass(z, t),
    ft: (t, n, o) => A ? attrClass(z, O, n, o) : (o ? addClass : removeClass)(z, t)
  };
  ...
  const {W: B, J: Y, Z: j, K: q, tt: N, nt: F} = k;
  const G = [ () => {
    removeAttr(Y, O);
    if (S) {
      removeAttr(y, O);
...
const createOverflowUpdateSegment = (t, n) => {
  const [o, s] = n;
  const {J: e, Z: c, K: r, nt: l, ut: i, ft: a, lt: u, et: d} = t;
  const {V: f, Y: _, I: h, L: g} = getEnvironment();
  ...
  return (t, n, l) => {
    ...
    if (u || w || v || k || j) {
      ...
      const h = {
        w: It((p ? d.innerWidth : f.w + It(i.w - e.w)) + o.w),
        h: It((p ? d.innerHeight + o.h : f.h + It(i.h - e.h)) + o.h)
      };
      Q = C(h);
    ...
    const [dt, ft] = L(getViewportOverflowState(F).$t);
    s({
      $t: dt,
      Ot: {
        x: nt.w,
...
const createDOMObserver = (t, n, o, s) => {
  let e = false;
  const {Lt: c, Ht: r, Mt: l, Pt: a, Dt: u, Rt: d} = s || {};
  const f = debounce((() => {
    if (e) {
      o(true);
    }
...
const createSizeObserver = (t, n, o) => {
  const {kt: s = false, Vt: e = false} = o || {};
  const c = getPlugins()[wt];
  const {B: r} = getEnvironment();
  const l = createDOM(`<div class="${k}"><div class="${B}"></div></div>`);
  const i = l[0];
  ...
  const onSizeChangedCallbackProxy = t => {
    ...
    if (s && a) {
      ...
      scrollLeft(i, n ? r.n ? -Rt : r.i ? 0 : Rt : Rt);
      scrollTop(i, Rt);
    }
    if (!c) {
      n({
...
const createStructureSetupObservers = (t, n, o) => {
  ...
  let e;
  let c;
  const {J: r, K: l, tt: i, rt: a, ut: d, dt: f, ft: _} = t;
  ...
  const onSizeChanged = ({gt: t, Bt: s, Vt: e}) => {
    const c = !t || e ? o : w;
    let r = false;
    if (s) {
      const [t, o] = s;
...
const createStructureSetup = (t, n) => {
  ...
  const [_, h, g, v] = createStructureSetupObservers(a, i, (t => triggerUpdateEvent(f(o, t), {}, false)));
  const w = l.bind(0);
  w.Yt = t => e("u", t);
  w.jt = () => {
    const {W: t, K: n} = a;
...
const createScrollbarsSetupElements = (t, n, o) => {
  ...
  const {slot: c} = e;
  const {ct: r, W: l, J: i, K: a, it: u, ot: d} = n;
...
const createScrollbarsSetup = (t, n, o) => {
  ...
  const [b, m] = selfClearTimeout((() => i));
  const [y, S, x] = createScrollbarsSetupElements(t, o.qt, createScrollbarsSetupEvents(n, o));
  const {J: $, K: C, ot: O, st: T, ut: E, lt: z} = o.qt;
  const {Jt: A, tn: I, Wt: L, Xt: H, Ut: M} = y;
  const {Qt: P} = A;
  const {Qt: D} = I;
...
const OverlayScrollbars = (t, n, o) => {
  const {F: s, q: e, j: c} = getEnvironment();
  const r = getPlugins();
  const l = isHTMLElement(t);
  const i = l ? t : t.target;
  const a = getInstance(i);
  if (n && !a) {
    let a = false;
    ...
    const y = {
      ...
      state() {
        const {Ot: t, Tt: n, $t: o, Et: s, Z: e, yt: c, wt: r} = g();
        return assignDeep({}, {
          overflowEdge: t,
          overflowAmount: n,
          overflowStyle: o,
      ...
      elements() {
        const {W: t, J: n, Z: o, K: s, tt: e, ot: c, st: r} = g.qt;
        const {Jt: l, tn: i} = p.qt;
        const translateScrollbarStructure = t => {
          const {Nt: n, Ft: o, Gt: s} = t;
          return {
            scrollbar: s,
            track: o,
            handle: n
    ...
    if (cancelInitialization(g.qt.lt, e().cancel, !l && t.cancel)) {
      destroy(true);
      return y;
    }
    g.jt();
    ...
    _("initialized", [ y ]);
    g.Yt(((t, n, o) => {
      const {gt: s, bt: e, ht: c, At: r, It: l, zt: i, vt: a, Ct: u} = t;
      _("updated", [ y, {
        updateHints: {
          sizeChanged: s,
          directionChanged: e,
...
OverlayScrollbars.env = () => {
  const {V: t, L: n, I: o, B: s, Y: e, H: c, X: r, U: l, q: i, N: a, F: u, G: d} = getEnvironment();
  return assignDeep({}, {
    scrollbarsSize: t,
