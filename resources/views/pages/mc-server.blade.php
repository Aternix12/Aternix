@extends('layouts.frontend') @section('content')
    <div class="content">
            ...
            <div class="col-md-6">
                <div class="block block-themed block-rounded">
                    ...
                    <div class="block-content">
                        ...
                        <h5>Players:
                            <span class="fw-semibold text-muted content-span">0/100 (Placeholder)</span>
                        </h5>
        ...
        <div class="row">
            <div class="col-md-12">
                <iframe src="https://thicc.connectminecraft.com" title="Thicc Craft Dynmap"></iframe>
            </div>
        </div>
                    ...
                    <ul class="nav nav-tabs nav-tabs-block" role="tablist" style="background-color: #6f9c40 !important;">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="btabs-static-profile-tab" data-bs-toggle="tab"
                                ...
                                aria-selected="false" tabindex="-1"><h3 class="block-title">Join for Bedrock</h3></button>
                        </li>
                    </ul>
