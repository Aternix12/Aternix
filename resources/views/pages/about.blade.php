        ...
        <div class="block-content">
          <div class="d-flex fs-sm">
            <a class="flex-shrink-0 img-link me-2" href="javascript:void(0)">
              <img class="img-avatar img-avatar48 img-avatar-thumb" src="assets/media/avatars/avatar4.jpg" alt="" title="" style="">
            </a>
            <div class="flex-grow-1">
              <p>
      ...
      <div class="timeline-event-block block block-rounded">
        ...
        <div class="block-content">
          <div class="d-flex fs-sm push">
            ...
            <div class="flex-grow-1">
              <p>
                You have a meal meeting scheduled with <a class="fw-semibold" href="javascript:void(0)">Thomas Riley</a> today at 16:18.
              </p>
            </div>
          </div>
        </div>
